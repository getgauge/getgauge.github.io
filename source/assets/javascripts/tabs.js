jQuery(document).ready(function($) {
    ...
    var startTabContainer = function() {
        $(".tab_content").hide();
        $(".tab_content." + $.client.os.toLowerCase()).show();
        $("." + $.client.os.toLowerCase()).addClass("active");
        $(".tab_container .tab-accordion_heading." + $.client.os.toLowerCase()).addClass("d_active");
